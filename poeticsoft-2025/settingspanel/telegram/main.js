...
/***/ "./src/settingspanel/telegram/main.scss":
/*!**********************************************!*\
  !*** ./src/settingspanel/telegram/main.scss ***!
  \**********************************************/
...
"use strict";
/*!********************************************!*\
  !*** ./src/settingspanel/telegram/main.js ***!
  \********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _main_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./main.scss */ "./src/settingspanel/telegram/main.scss");
...
var PoeticsoftPostSettingsTelegram = function PoeticsoftPostSettingsTelegram() {
  ...
  var postDateHuman = moment__WEBPACK_IMPORTED_MODULE_0___default()(postDate).fromNow();
  ...
  var _useState3 = useState(false),
    ...
    publishing = _useState4[0],
    setPublishing = _useState4[1];
  var _useState5 = useState(''),
    _useState6 = _slicedToArray(_useState5, 2),
    message = _useState6[0],
    setMessage = _useState6[1];
  var _useEntityProp = useEntityProp('postType', 'post', 'meta'),
  ...
  var publish = function publish() {
    ...
    fetch("/wp-json/poeticsoft/telegram/publishwp?type=post&postid=".concat(postId)).then(function (result) {
  ...
  var publishActivate = function publishActivate(state) {
    setMeta(_objectSpread(_objectSpread({}, meta), {}, {
      poeticsoft_post_publish_telegram_active: state
    }));
  };
  var publishOnChangeActivate = function publishOnChangeActivate(state) {
    if (!state) {
      fetch("/wp-json/poeticsoft/telegram/disableonchange?postid=".concat(postId)).then(function (result) {
        return result.json().then(function (disabled) {
  ...
  var changeDestination = function changeDestination(destination) {
    setMeta(_objectSpread(_objectSpread({}, meta), {}, {
    ...
    fetch('/wp-json/poeticsoft/telegram/destinationlist').then(function (result) {
      return result.json().then(function (list) {
        if (!meta.poeticsoft_post_publish_telegram_destination) {
          var defaultoption = list.find(function (o) {
            return o["default"];
          });
          setMeta(_objectSpread(_objectSpread({}, meta), {}, {
  ...
  return /*#__PURE__*/React.createElement(PluginDocumentSettingPanel, {
    ...
    className: "Settings"
  }, meta.poeticsoft_post_publish_telegram_lastpublishdate && /*#__PURE__*/React.createElement("div", {
    className: "LastPublishDate"
  }, /*#__PURE__*/React.createElement("span", {
    className: "Text"
  }, "PUBLICADO:"), ' ', /*#__PURE__*/React.createElement("span", {
    className: "Date"
  }, moment__WEBPACK_IMPORTED_MODULE_0___default()(meta.poeticsoft_post_publish_telegram_lastpublishdate).format('L-LTS'))), /*#__PURE__*/React.createElement(CheckboxControl, {
    label: "Publicar",
    help: meta.poeticsoft_post_publish_telegram_active ? postStatus != 'publish' ? "Se publicar\xE1 en Telegram cuando se publique la p\xE1gina, programada para ".concat(postDateHuman, "...") : "Selecciona \"Publicar ahora\" para publicar en Telegram" : '',
    ...
    variant: "primary",
    disabled: !meta.poeticsoft_post_publish_telegram_active || publishing,
    onClick: publish
  }, "Publicar ahora"), /*#__PURE__*/React.createElement("div", {
    className: "Message"
  }, message != '' && message)));
};
registerPlugin('poeticsoft-post-settings-telegram', {
